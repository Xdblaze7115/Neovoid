...
struct Camera { // Basically moves the "world" around you
private:
    XMVECTOR Forward = XMVectorSet(0, 0, 1, 0);
    XMVECTOR Up = XMVectorSet(0, 1, 0, 0);
    XMVECTOR Right = XMVectorSet(1, 0, 0, 0);

    XMVECTOR Position = XMVectorSet(0, 0, 0, 1); // X, Y, Z Used By Matrix
    XMVECTOR Rotation = XMVectorSet(0, 0, 0, 1); // Roll, Pitch, Yaw
